...
<svelte:head>
  ...
  <meta
    name="description"
    content="Join the Treasure Tavern account waitlist - Be the first to know when account creation is available and get early access to our exclusive features."
  />
  <link
    rel="stylesheet"
