...
const talesData = [
  {
    ...
    excerpt:
      'In the gleaming city of Vitralis, a young apprentice glassblower discovers her mentor holds a dangerous secret—the ability to trap souls within her delicate creations.',
  ...
  },
  {
    ...
    excerpt:
      'When a desperate village makes a bargain with the notorious Sorceress of Storms to end a devastating drought, a young apprentice discovers the true price of commanding the weather.',
  ...
  },
  {
    ...
    excerpt:
      'Far beneath the living world lies the Bone Kingdom, where a silent ruler passes judgment on the dead and living alike, and a traveler seeks what was stolen.',
