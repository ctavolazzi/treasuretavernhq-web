...
const taleContentTemplate =
`This is a template for your tale content.
                ...
                rl.question('Add media? (none/audio/video): ', (mediaType) => {
                  ...
                  if (['audio', 'video'].includes(mediaType.toLowerCase())) {
                    ...
                    rl.question('Media content path: ', (mediaPath) => {
                      ...
                      createTaleFiles(slug, title, author, excerpt, category, date, tags, featured, mediaTypeValue, mediaContent);
                    });
                  } else {
                    createTaleFiles(slug, title, author, excerpt, category, date, tags, featured, mediaTypeValue, mediaContent);
                  }
 ...
 */
function createTaleFiles(slug, title, author, excerpt, category, date, tags, featured, mediaType, mediaContent) {
